...
export const MaskedInput = forwardRef<HTMLInputElement, MaskedInputProps>(
  (
    ...
    const handleChange = (e: ChangeEvent<HTMLInputElement>) => {
      ...
      const unmaskedValue =
        mask === 'placa' ? rawValue.toUpperCase().replace(/[^A-Z0-9]/g, '') : unmask(rawValue)
    ...
    const displayValue =
      mask !== 'none' && typeof value === 'string' ? applyMask(value, mask) : value
...
export const CPFCNPJInput = forwardRef<HTMLInputElement, Omit<MaskedInputProps, 'mask'>>(
  (props, ref) => <MaskedInput ref={ref} mask="cpfCnpj" placeholder="CPF ou CNPJ" {...props} />
)
...
export const PlacaInput = forwardRef<HTMLInputElement, Omit<MaskedInputProps, 'mask'>>(
  (props, ref) => <MaskedInput ref={ref} mask="placa" placeholder="ABC-1234" {...props} />
)
PlacaInput.displayName = 'PlacaInput'

export const CurrencyInput = forwardRef<HTMLInputElement, Omit<MaskedInputProps, 'mask'>>(
  (props, ref) => <MaskedInput ref={ref} mask="currency" placeholder="0,00" {...props} />
)
