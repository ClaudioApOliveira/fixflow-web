    ...
    ({ className = '', label, error, hint, id, style, ...props }, ref) => {
        ...
        return (
            <div className="space-y-1.5">
                ...
                <div className="relative bg-secondary/50 rounded-xl border border-border overflow-hidden focus-within:ring-2 focus-within:ring-ring focus-within:border-transparent transition-all duration-200"
                    style={error ? { borderColor: 'var(--color-danger)', borderWidth: '1px', boxShadow: '0 0 0 2px var(--color-danger-opacity)' } : {}}
                >
                    {/* Linhas do caderno */}
                    <svg
