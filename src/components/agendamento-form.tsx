...
import { useClientes, useVeiculosByCliente, useUsuarios, useDisponibilidadeMecanicos } from '@/lib/hooks'
...
export function AgendamentoForm({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (formData.clienteId === 0 || !formData.clienteId) newErrors.clienteId = 'Selecione um cliente'
        if (formData.veiculoId === 0 || !formData.veiculoId) newErrors.veiculoId = 'Selecione um veículo'
        if (formData.mecanicoId === 0 || !formData.mecanicoId) newErrors.mecanicoId = 'Selecione um mecânico'
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input
                            ...
                            value={format(toSaoPauloTime(new Date(formData.dataHoraInicio)), "yyyy-MM-dd'T'HH:mm")}
                            onChange={(e) => {
                    ...
                    <div>
                        ...
                        />
                        {errors.dataHoraFim && (
                            <p className="text-xs text-danger mt-1">{errors.dataHoraFim}</p>
                        )}
                    </div>
                </div>
