...
// Ícone de MoreVertical (3 pontos)
...
// Ícone de CirclePause (em progresso)
export function CirclePauseIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
