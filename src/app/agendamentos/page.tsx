                ...
                <div className="space-y-6">
                    ...
                    <Card>
                        <div className="p-4 space-y-2">
                            <p className="text-xs font-semibold text-foreground uppercase tracking-wide mb-3">Resumo</p>
                ...
                >
                    <div className="space-y-4">
                        <div className="flex items-center justify-between pb-3 border-b border-border">
                            ...
                            <Badge
                                className={`${STATUS_CONFIG[selectedAgendamento.status].bg} ${STATUS_CONFIG[selectedAgendamento.status].text
                                    }`}
                            >
