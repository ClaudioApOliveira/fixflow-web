...
import { ArrowLeftIcon, PlusIcon, PencilIcon, TrashIcon, WrenchIcon } from '@/components/icons'
            ...
            <TableBody>
              {servicos.map((servico) => (
                <TableRow key={servico.id}>
                  <TableCell>
                    <Badge>{getTipoServicoLabel(servico.tipoServico)}</Badge>
                  </TableCell>
                  <TableCell>
                    <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Input
              ...
              onChange={(e) => {
                setFormData({
                  ...formData,
                  kmVeiculo: e.target.value ? parseInt(e.target.value) : undefined,
                })
