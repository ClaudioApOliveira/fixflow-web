      ...
      if (selectedUsuario) {
        ...
        if (!formData.senha) {
          ...
          await updateUsuario.mutateAsync(
            dataWithoutPassword as Parameters<typeof updateUsuario.mutateAsync>[0]
          )
        } else {
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                {ROLES_OPTIONS.filter((role) => isAdmin || !role.adminOnly).map((role) => (
                  <button
                    key={role.value}
                    type="button"
            ...
            <div className="flex justify-end gap-3 pt-4">
              ...
              <Button type="submit" isLoading={createUsuario.isPending || updateUsuario.isPending}>
